...
namespace BlockchainAssignment
{
    public partial class BlockchainApp : Form
    {
        ...
        {
            List<Transaction> selectedTransactions = blockchain.SelectTransactionsFromPool("Greedy");
            Block newBlock = new Block();
            string blockHash = newBlock.Mine(1, selectedTransactions);
            newBlock.transactionList = selectedTransactions;
            ...
            {
                UpdateText("From: " + transaction.senderAddress + " To: " + transaction.recipientAddress + " Amount: " + transaction.amount + " Fee: " + transaction.fee);
            }
        ...
        {
            List<Transaction> selectedTransactions = blockchain.SelectTransactionsFromPool("Altruistic Mining");
            Block newBlock = new Block();
            string blockHash = newBlock.Mine(1, selectedTransactions);
            newBlock.transactionList = selectedTransactions;
            newBlock.hash = blockHash;
            ...
            // Update the text in the user interface with the blockchain details
            UpdateText(blockchain.ToString());

            // Display information about each transaction in the user interface
            foreach (Transaction transaction in blockchain.transactionPool)
            {
                UpdateText("From: " + transaction.senderAddress + " To: " + transaction.recipientAddress + " Amount: " + transaction.amount + " Fee: " + transaction.fee);
            }
        ...
        private void AddressBasedMiningButton_Click(object sender, EventArgs e)
        {
            // Retrieve the target wallet address from the addressTextBox
            string walletAddress = addressTextBox.Text;

            // Select transactions from the pool that contain the target wallet address
            List<Transaction> selectedTransactions = blockchain.SelectTransactionsFromPool("Address Based", walletAddress);
        ...
        private void RandomMiningButton_Click(object sender, EventArgs e)
        {
            List<Transaction> selectedTransactions = blockchain.SelectTransactionsFromPool("Random");
            Block newBlock = new Block();
            string blockHash = newBlock.Mine(1, selectedTransactions);
            newBlock.transactionList = selectedTransactions;
            newBlock.hash = blockHash;
